  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="text-center items-center mx-auto w-auto"><Logo /></div>
          ...
          <div className="flex m-auto w-full">
            <div className="mt-2 w-[47%]">
              <input
                ...
                required
                className="block pl-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder:text-center focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>

            <div className="mt-2 ml-auto w-[47%]">
              <input
                id="lastName"
                name="text"
                type="text"
